...
st.markdown("This is a streamlit dashboard to analyse motor vehicle collisionÃ°ÂÂÂ¥!")
...
injured_people=st.slider("Number of people injured in vechicle Collision",0,19)
st.map(data.query("injured_persons >= @injured_people")[["latitude","longitude"]].dropna(how="any"))


st.header("How many collisions occured at a  given time of a  day")
...
st.subheader("Breakdown of minutes between %i:00 and %i:00" % (hour,(hour+1)%24))
filtered=data[
